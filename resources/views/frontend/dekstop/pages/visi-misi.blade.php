    ...
    <div class="content-home" id="content">
        <div class="content-article mt-15">
            <article class="article-detail">
                <h3 class="card-headline-no-image-title-detail">VISI DAN MISI Automoto.id</h3>
                <div class="article-detail--body">

                    <p><strong>Automoto.id</strong> Hadir menyuguhkan berita terkini dari kalangan selebritis ternama Tanah
                        Air maupun Internasional. Disajikan dengan cepat, tepat, ringan.</p>

                    <p>Sesuai dengan hakikatnya, konten Automoto.id sebagai media hiburan disajikan dengan gaya bahasa yang
                        segar dan kekinian.</p>

                    <p>Ulasan Automoto.id tidak hanya meliputi aktifitas para pesohor saat menjalankan profesinya di dunia
                        hiburan, namun juga sisi menarik lainnya mencakup kehidupan sehari-hari yang sudah barang tentu
                        menarik untuk disimak.</p>

                    <p>Automoto.id mengangkat kabar dari kalangan hiburan melalui perspektif milenial dan gen Z dengan
                    ...
                    <p>Lahir dari rahim Forum Terkini Media, Automoto.id menyajikan aktifitas dan gaya hidup kaum pesohor
                        lewat kaca mata kemewahan, keluarga, berita dan peristiwa terbaru.</p>

                    <p>Selamat berselancar bersama <strong>Automoto.id</strong>!</p>
